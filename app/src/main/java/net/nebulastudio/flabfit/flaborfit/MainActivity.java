package net.nebulastudio.flabfit.flaborfit;
...
public class MainActivity extends AppCompatActivity {
    ...
    public static final String EXTRA_ITEM_IMAGE = "extra.item.image";
    ...
    private void loadDetailActivity(String exerciseTitle) {
        ...
        //intent.putExtra(MainActivity.EXTRA_ITEM_IMAGE, exerciseTitle);
